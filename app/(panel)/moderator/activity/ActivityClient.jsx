    ...
    <main className="app-container">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-black">
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">No Activity Logs Found</h3>
          <p className="mt-2 text-sm text-zinc-500 max-w-xs">
            There are currently no moderation logs to display. All system audit trails will appear here.
          </p>
        </div>

        {/* Footer info/tip */}
        <div className="mt-6 flex items-start gap-3 rounded-xl bg-blue-50/50 p-4 border border-blue-100/50 dark:bg-blue-900/10 dark:border-blue-900/20">
          ...
          <p className="text-xs leading-relaxed text-blue-700/80 dark:text-blue-300/80">
            <strong>System Audit Tip:</strong> Moderation logs are permanent and cannot be deleted. They provide a transparent history of all administrative actions for security and compliance.
          </p>
        </div>
      </div>
    </main>
